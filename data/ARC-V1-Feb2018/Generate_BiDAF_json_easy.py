...
json_data=open("ARC-Easy/ARC-Easy-Test_with_paras_TUNED_or.jsonl","r")
json_data_write=open("ARC-Easy/ARC-Easy-Test_with_paras_TUNED.jsonl","w")

# justification_file = open("/Users/vikasy/SEM_5/ARC_Challenge_BM25/Challenge_test_QuestionCand_3_60_explanations_BM25.txt","r")
# justification_file = open("/Users/vikasy/SEM_5/ARC_multi-hop/Multihop_optimization_Easy/EASY_test_Good_justifications.txt","r")
...
for line in justification_file:
    ...
    good_just1 += " " + " ".join(all_just[5].split()[1:])
